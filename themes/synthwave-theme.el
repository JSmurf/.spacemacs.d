;;; synthwave-theme.el --- Color theme based on the Spacemacs theme

;; Copyright (C) 2019 Alex Cooper

;; Author: Alex Cooper
;; URL: <https://github.com/jsmurf/.spacemacs.d>
;;
;; Version: 0.1
...
;; This is based on the original Spacemacs theme (dark and light)
;; The colors are inspired by the SynthWave '84 VS Code Theme by Robb Owen <https://github.com/robb0wen/synthwave-vscode>.
...
(defcustom spacemacs-theme-comment-bg f
...
(deftheme synthwave)
  (let ((class '((class color) (min-colors 89)))
        ...
        (act2          "#2A2139")
        (base          "#FFFFFF")
        (base-dim      "#B6B1B1") ;; Experimental color
        (bg1           "#262335")
        (bg2           "#08080F")
        (bg3           "#213999")
        (bg4           "#232530")
        ...
        ;; colors
        (aqua          "#2D9574") ;; From Spacemacs-Dark
        (aqua-bg       "#2A2139")
        (green         "#3AD900") ;; From Cobalt 2
        (green-bg      "#2A2139")
        (green-bg-s    "#3AD900")
        (cyan          "#03EDF9")
        (red           "#FE4450")
